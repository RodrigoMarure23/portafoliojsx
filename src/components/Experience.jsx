  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute left-0 top-0 -translate-x-[9px] w-4 h-4 rounded-full bg-gradient-to-r from-cyan-500 to-purple-500 border-4 border-[#0a0e27] shadow-lg shadow-cyan-500/50"
      ></motion.div>
...
const certifications = [
  {
    title: "Master en Desarrollo Full Stack",
    institution: "DEV.F",
    date: "Nov 2022",
  },
  {
        ...
        >
          ...
          <div className="space-y-6">
            {certifications.map((cert, index) => (
              <div
                key={index}
                className="bg-[#0f1629] rounded-xl p-6 border border-purple-500/20 hover:border-purple-500/50 hover:shadow-xl hover:shadow-purple-500/20 transition-all"
              >
                <div className="flex flex-wrap items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="text-slate-400">{cert.institution}</p>
                  </div>
